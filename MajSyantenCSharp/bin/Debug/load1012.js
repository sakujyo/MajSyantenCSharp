...
function cbtest(hensuu){dakouho = new Array(); yharray = new Array(); printTehai("q", document.f.q.value); dakouho.push(dakouho.length); dakouho.reverse(); return dakouho;}
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
document.write(
	"<form name=f style=\"margin:0px;\" >"+
		"<a href=\"?\" >新規</a> | "+
		"手牌 <input type=text name=q size=40 ><input type=submit value=\" OK \">"+
